...
class BudgetPage extends StatefulWidget {
  var root;
  BudgetPage(RootApp rootApp){
root=rootApp;
  }

  @override
  _BudgetPageState createState() => _BudgetPageState(root);
}

class _BudgetPageState extends State<BudgetPage> {
  int activeDay = 3;
  var root;
  _BudgetPageState(RootApp root){
    this.root=root;
  }
  @override
      ...
      child: Column(
        children: [
                        ...
                        children: [
                          IconButton(
                            onPressed: () {
                              ...
                              showDialog(
                                context: context,
                                builder: (BuildContext context) => getbuildPopupDialog(context,root),
                              );
                              });
                            },
                            icon:Icon(
          ...
          Padding(
            ...
            child: Column(
                children: getColumn(budget_json, size),
            ),
          )
        ],
      ),
  ...
  List<Widget> getColumn(List data,Size size) {
    List<Widget> list=[];
